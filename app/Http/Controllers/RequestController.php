...
class RequestController extends Controller
{
    ...
    protected static function handleErrors(Client $client, $request) : array|Response
    {
        try {
...
//                Log::warning($exception->getMessage());
    ...
    private static function changeAndTryRequest(Client $client, Request $request) : Response
    {
